 ...
 * 2.添加自己的属性信息
 * 3.创建保存
 *   MyDBAPIManager *model= [[MyDBAPIManager alloc] init];
 *   model.name=@"ceshi";
 *   [model save];保存到数据库 数据库名称为MyDBAPIManager 类名
 *   具体参考链接：https://github.com/Haley-Wong/JKDBModel
 *
 */
...
@interface DBAPIManager : NSObject
